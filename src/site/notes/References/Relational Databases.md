...
SQL digunakan untuk mendefinisikan, membaca, dan mengubah data pada sistem relasional. [[References/PostgreSQL\|PostgreSQL]], [[References/MySQL\|MySQL]], dan Oracle Database merupakan contoh produk yang dibahas di sini; model relasional tidak menyamakan fitur maupun konfigurasi ketiganya.
